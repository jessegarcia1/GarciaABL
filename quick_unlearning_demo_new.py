...
def train(opt):
    ...
    poisoned_data = np.load(opt.isolate_data_root, allow_pickle=True) # The poisoned / seperated data is already given. Use backdoor_isolation to actually isolate the data
